...
### Split data of table into AP1 subfamilies based on genes.
```{r AP1_subfamily, include=TRUE, echo=TRUE}
...
write.table(df_AP1_family_all, "./output/Spleen_FC_AP1_all.txt", sep="\t", quote=FALSE)
```

#########################################################
### Generate the boxplot to visualize the fold change differences with age for AP1 subfamilies.
```{r generate_boxplot_AP1_subfamily, include=TRUE, echo=TRUE}
#One sample t-test
...
pdf("./output/Boxplot_Spleen_FC_RNA_DE_not_filtered_all_24_AP1_genes.pdf", height=10, width=10)
p
dev.off()
