...
# PATH: path of the enriched modules files
# PATH_TO_SAVE:  
er_plot_atac <- function(path, path_to_save, gsea = F){
...
er_plot_atac("output/F3/Enrichment Files/Hypergeometric/ATACseq/", 
        "output/F3/Enrichment Figures/ATACseq/Cell_types_")


er_plot_atac("output/F3/Enrichment Files/GSEA/ATACseq/", 
        "output/F3/Enrichment Figures/ATACseq/Cell_types_", gsea = T)
```
