...
gene_Vln_Pie <- function(mydata, gene_name, Celltype) {
	...
	outfile = paste0("./Violin_plots/","VlnPlot_Pie_chart_",Celltype, "_", gene_name, "_new", ".pdf")
	outfile1 = paste0("./Violin_plots/","VlnPlot_",Celltype, "_", gene_name, "_new", ".pdf")
	outfile2 = paste0("./Violin_plots/","Pie_chart_",Celltype, "_", gene_name, "_new", ".pdf")
...
#args[1] = "/projects/anczukow-lab/neerja_projects/Integrate_expt1_expt2_only/Analysis_PC_10_mt10/RDS_files/seuratObject_rename_ident_May26_2021.rds"
#args[2] = "Pdk4"
#args[3] = "Luminal-AV"
...
#mydata_subset_TM1 <- subset(mydata, subset = expt == "tabula_muris")
#mydata_subset_TM2 <- subset(mydata_subset_TM1, subset = age == c("mm10_3mths_TM", "mm10_18mths_TM"))
#mydata_subset_TM2 <- subset(mydata, subset = age == c("3m", "18m"))
